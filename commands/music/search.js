...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (!res || !res.tracks.length) return message.channel.send(`Cannot find my results in archives ${message.author}... try again ? ❌`);
        ...
        embed.setTimestamp();
        embed.setFooter('Nya! Enjoy your music.', message.author.avatarURL({ dynamic: true }));
